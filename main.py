...
def attack(char_name: str, char_class: str) -> str:
    """Determine the ammount of damage depending on a class."""
...
def defence(char_name: str, char_class: str) -> str:
    """Determine the ammount of damage blocked depending on a class."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Print the special cast depending on the class."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Print the welcome message depending on a class."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Ask user to choose the player class."""
    approve_choice: str = ''
    char_class: str = ''
